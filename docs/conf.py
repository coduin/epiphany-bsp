...
# -*- coding: utf-8 -*-
#
# Epiphany BSP documentation build configuration file, created by
...
# of the sidebar.
html_logo = "img/coduin_logo_small.png"
...
htmlhelp_basename = 'EpiphanyBSPdoc'
...
man_pages = [
    (master_doc, 'epiphanybsp', 'Epiphany BSP Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'EpiphanyBSP', 'Epiphany BSP Documentation',
   author, 'EpiphanyBSP', 'One line description of project.',
   'Miscellaneous'),
]
